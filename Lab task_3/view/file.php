...
<body>
    <h1>Registration Form</h1>
     <form action="" method="POST" enctype="multipart/form-data">
       ...
       <td><input type="radio"  name="Designation"value="J_pro">Junior Programmer 
       <input type="radio"name="Designation" value="S_pro">Senior Programmer 
       <input type="radio"  name="Designation"value="P_lead">Project Lead</td></tr>
